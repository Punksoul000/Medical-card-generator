...
<head>
    ...
    <title>Medical Card Generator System | Medical Card Created Today</title>
       ...
       <?php include_once('includes/header.php');?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Manage Todays Medical Card</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
$sql="SELECT * from tblmedicalcard where date(CreationDate)=CURDATE()";
