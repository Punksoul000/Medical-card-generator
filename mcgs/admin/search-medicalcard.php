...
<head>
    ...
    <title>Medical Card Generator System | Search Medical Card</title>
       ...
       <?php include_once('includes/header.php');?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Search Medical Card</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
...
<form method="post">
                                <div class="form-group">
                                    <label>Search by Reference Number/Mobile Number</label>
